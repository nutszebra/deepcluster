...
class AlexNet(nn.Module):
    ...
    def crit(self, y, t):
        ...
        return loss - self.beta * loss_push2
...
def alexnet(sobel=False, bn=True, out=32, length_train=None, alpha=1.0e-2, memory_dim=10000, momentum=0.99, reassign_period=200, beta=1.0e-3):
    dim = 2 + int(not sobel)
